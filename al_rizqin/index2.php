...
function myFunction() {
    ...
    <div class="single-blog-wrapper section-padding-0-100">
		...
		<h2>Welcome <?php echo $query2['vname']; ?> To Customer Dashboard</h2>			
		...
		<hr></br>
					...
					<center>
						<button type="submit" class="btn original-btn" onclick="window.location='<?php echo "book.php?vname=".$vname.""; ?>'">Register a Cube</button>
                        
					</center>
                        <h5 class="title">Status of register</h5>
                        ...
                        <ol>
                            ...
                            <?php
										include 'connection.php';
										$vname=$_GET['vname'];
										$query = "SELECT * FROM booking WHERE vname='$vname'";
										...
										<td>
										<p><a href='delete.php?orderID=".$row['orderID']."&vname=".$vname."'><input type='button' value='Decline'></a></p>
										</td>
										</tr>
										</table></br>";
										}
